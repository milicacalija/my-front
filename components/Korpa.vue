...
export default {
  ...
  handleImageError(event, pro_iupac) {
    if (event && event.target) {
      event.target.src = '/images/korpica.png'; // fallback slika
...
@media (max-width: 480px) {
  ...
  .cart-popup {
    width: 95%;        /* popup skoro cela širina ekrana */
    padding: 10px;
  }

  .cart-item {
    flex-direction: column;  /* stavke jedna ispod druge */
